...
const PRESETS = [
  ...
  {
    name: 'Shirol Sugarcane',
    label: 'Shirol Panchganga-Krishna Confluence',
    temp_c: 28.5,
    solar_rad_mj: 21.0,
    rh_pct: 65.0,
    wind_speed_ms: 2.2,
    ...
    longitude_deg: 74.58,
    soil_type: 'clay_loam',
    volumetric_moisture: 0.32,
    crop_type: 'sugarcane',
    growth_stage: 'mid',
    custom_yield_ton_ha: 115.0,
    time_period_mode: 'growing_season',
    duration_days: 360.0,
    target_horizon_year: 2030
  },
  {
    name: 'Hatkanangale Cotton',
    label: 'Hatkanangale Northern Belt',
    temp_c: 29.5,
    solar_rad_mj: 22.0,
    rh_pct: 55.0,
    wind_speed_ms: 2.8,
  ...
  {
    name: 'Radhanagari Rice',
    label: 'Radhanagari Western Ghats Basin',
    temp_c: 24.5,
    solar_rad_mj: 16.5,
    rh_pct: 85.0,
    wind_speed_ms: 2.4,
